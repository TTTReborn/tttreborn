...
namespace TTTReborn
{
	...
	public partial class WalkController : BasePlayerController
    {
        ...
        {
            float girth = BodyGirth * 0.5f;
            Vector3 mins = new(-girth, -girth, 0);
            Vector3 maxs = new(+girth, +girth, BodyHeight);
        ...
        public virtual void UpdateBBox()
        {
            ...
            Vector3 mins = new Vector3(-girth, -girth, 0) * Pawn.Scale;
            Vector3 maxs = new Vector3(+girth, +girth, BodyHeight) * Pawn.Scale;
        ...
        public override void Simulate()
        {
            ...
            */
            ...
            //
            WishVelocity = new( pl.InputDirection.x.Clamp( -1f, 1f ), pl.InputDirection.y.Clamp( -1f, 1f ), 0);
        ...
        public virtual void WalkMove()
        {
            ...
            try
            {
                ...
                Vector3 dest = new Vector3(Position + Velocity * Time.Delta).WithZ(Position.z);
        ...
        public virtual void Accelerate(Vector3 wishdir, float wishspeed, float speedLimit, float acceleration)
        {
            ...
            float accelspeed = acceleration * Time.Delta * wishspeed * SurfaceFriction;
        ...
        public virtual void CheckLadder()
        {
            ...
            Vector3 wishvel = new( pl.InputDirection.x.Clamp( -1f, 1f ), pl.InputDirection.y.Clamp( -1f, 1f ), 0);
        ...
        public virtual void LadderMove()
        {
            ...
            Vector3 cross = LadderNormal * normalDot;
        ...
        public virtual void CategorizePosition(bool bStayOnGround)
        {
            ...
            TraceResult pm = TraceBBox(vBumpOrigin, point, 4.0f);
        ...
        /// </summary>
        public override TraceResult TraceBBox(Vector3 start, Vector3 end, float liftFeet = 0.0f) => TraceBBox(start, end, mins, maxs, liftFeet);
        ...
        public virtual void StayOnGround()
        {
            ...
            if (trace.Fraction <= 0 || trace.Fraction >= 1 || trace.StartedSolid || Vector3.GetAngle(Vector3.Up, trace.Normal) > GroundAngle)
            {
                return;
            }
