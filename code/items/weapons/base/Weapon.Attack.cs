...
namespace TTTReborn.Items
{
    public abstract partial class Weapon
    {
        public virtual bool CanAttack(ClipInfo clipInfo, InputButton inputButton)
        {
            ...
            return ClipDataList[clipInfo.DataIndex].TimeSinceAttack > GetRealRPM(clipInfo.RPM);
        }
        ...
        public virtual void Attack(ClipInfo clipInfo)
        {
            ...
            if (clipInfo.IsPartialReloading && ClipDataList[clipInfo.DataIndex].IsReloading)
            {
                OnReloadFinish(clipInfo);
            }

            ClipDataList[clipInfo.DataIndex].TimeSinceAttack = 0f;
