...
//         public Tooltip(Sandbox.UI.Panel relatedPanel, Action<Tooltip> onCreate = null, Action<Tooltip> onDelete = null, Action<Tooltip> onTick = null) : base(new Globalization.TranslationData())
//         {
...
//     {
//         public static void AddTooltip(this Sandbox.UI.Panel self, string text = "", string className = null, Action<Tooltip> onCreate = null, Action<Tooltip> onDelete = null, Action<Tooltip> onTick = null, params object[] args)
//         {
...
//                 CreateTooltip(self, text, className, onCreate, onDelete, onTick, args);
//             });
...
//         private static Tooltip CreateTooltip(Sandbox.UI.Panel panel, string text = "", string className = null, Action<Tooltip> onCreate = null, Action<Tooltip> onDelete = null, Action<Tooltip> onTick = null, params object[] args)
//         {
//             DeleteTooltip();

//             Tooltip tooltip = new(panel, onCreate, onDelete, onTick);
//             tooltip.SetTranslation(new TTTReborn.Globalization.TranslationData(text, false, args));
