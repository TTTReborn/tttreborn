...
{ 
    public class EntityHintPanel : TTTPanel
    {
        ...
        {
            base.Tick();
            IsShowing = true; //If our panel exists, it should always be showing. Panels are disgarded immediately when the player looks away.
        ...
        public EntityHintPanel(string title = "", string subtitle = null)
        {
            ...
            BottomPanel = Add.Panel("topWrapper");
            TopPanel = BottomPanel.Add.Panel("bottomWrapper");
            ...
            IsShowing = false; //Hide until first tick.
        }
