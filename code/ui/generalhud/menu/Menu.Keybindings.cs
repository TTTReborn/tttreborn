...
namespace TTTReborn.UI.Menu
{
    public partial class Menu
    {
        private void OpenKeybindings(PanelContent menuContent)
        {
            ...
            {
                panelContent.Add.TranslationLabel(new TranslationData("MENU_KEYBINDINGS_DESCRIPTION"));
                panelContent.Add.Label("");

                panelContent.Add.TranslationLabel(new TranslationData("MENU_KEYBINDINGS_MOVEMENT"), "binding-header");
                ...
                panelContent.Add.TranslationLabel(new TranslationData("MENU_KEYBINDINGS_WEAPONS"), "binding-header");
                ...
                panelContent.Add.TranslationLabel(new TranslationData("MENU_KEYBINDINGS_ACTIONS"), "binding-header");
                ...
                panelContent.Add.TranslationLabel(new TranslationData("MENU_KEYBINDINGS_COMMUNICATION"), "binding-header");
                ...
                panelContent.Add.TranslationLabel(new TranslationData("MENU_KEYBINDINGS_MENUS"), "binding-header");
