...
namespace TTTReborn.UI
{
    public partial class QuickShop : Panel
    {
        ...
        public void Update()
        {
            _creditLabel.SetTranslation(new TranslationData("QUICKSHOP_CREDITS_DESCRIPTION", false, _credits));
            ...
            {
                _itemDescriptionLabel.SetTranslation(new TranslationData("QUICKSHOP_ITEM_DESCRIPTION", false, _selectedItemData?.Name.ToUpper()));
            }
        }
