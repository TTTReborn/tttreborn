...
namespace TTTReborn.UI
{
    public class C4Arm : Panel
    {
        ...
        public C4Arm() : base()
        {
            ...
            actionButtons.Add.TranslationButton(new Globalization.TranslationData("C4_UI_PICKUP"), "button action-button", () =>
            {
                C4Entity.PickUp(Entity.NetworkIdent, Local.Pawn.NetworkIdent);
            });

            actionButtons.Add.TranslationButton(new Globalization.TranslationData("C4_UI_DESTROY"), "button action-button", () =>
            {
                C4Entity.Delete(Entity.NetworkIdent);
            });

            actionButtons.Add.TranslationButton(new Globalization.TranslationData("C4_UI_ARM"), "button arm-button", () =>
            {
        ...
        private void SetTimer(int presetIndex)
        {
            ...
            _defuseChance.SetTranslation(new Globalization.TranslationData("C4_UI_DEFUSECHANCE", false, (1f / preset.Wires * 1000f).FloorToInt() / 10f));
        }
