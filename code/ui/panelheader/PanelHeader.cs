...
namespace TTTReborn.UI
{
    public partial class PanelHeader : Panel
    {
        ...
        public void SetTranslationTitle(string translationKey, params object[] args)
        {
            _title.SetTranslation(new Globalization.TranslationData(translationKey, false, args));
        }
